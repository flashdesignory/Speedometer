        ...
        <svg viewBox="-0.5 -0.5 17 17">
            ...
            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g transform="translate(1.000000, 0.000000)" fill="#434343" style={{ transform: "rotate(90deg)", transformBox: "fill-box", transformOrigin: "center" }}>
                    <path d="M9.956,6.326 C9.956,6.676 9.657,6.958 9.287,6.958 L0.689,6.958 C0.318,6.958 0.019,6.676 0.019,6.326 L0.019,0.633 C0.019,0.283 0.318,0 0.689,0 L9.287,0 C9.657,0 9.956,0.283 9.956,0.633 L9.956,6.326 L9.956,6.326 Z"></path>
